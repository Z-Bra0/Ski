...
var builtinSpecs = []builtinSpec{
	...
	{Name: "copilot", ProjectDir: ".github/skills", GlobalDir: ".github/skills"},
	{Name: "windsurf", ProjectDir: ".windsurf/skills", GlobalDir: ".codeium/windsurf/skills"},
	{Name: "gemini", ProjectDir: ".gemini/skills", GlobalDir: ".gemini/skills"},
	{Name: "antigravity", ProjectDir: ".agent/skills", GlobalDir: ".gemini/antigravity/skills"},
